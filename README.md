...
On an UNO the absolute minimum memory footprint is 21966 bytes (68%) and 945 global variables (46%). For a Leonardo that is 24916 bytes (86%) and 1112 bytes  (43%) of global variables.
